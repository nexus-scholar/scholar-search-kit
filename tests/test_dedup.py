...
def test_dedup_metadata_merging():
    doc_openalex = Document(
        ...
        year=2017,
        provider="openalex",
        external_ids=ExternalIds(doi="10.5555/3295222.3295349", openalex_id="W2741809807"),
    ...
    doc_s2 = Document(
        ...
        external_ids=ExternalIds(doi="10.5555/3295222.3295349", s2_id="204e3073870fae3d05bcbc2f6a8e263d9b72e776"),
    ...
    assert rep.abstract == "We propose a new simple network architecture, the Transformer..."
